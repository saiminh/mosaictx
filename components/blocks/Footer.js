    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.footer__links}>
        ...
        <div className={styles.footer__links__navigation}>
          ...
          <svg className={styles.footer__links__navigation__cubelogo} width="63" height="62" viewBox="0 0 63 62" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="-0.00976562" width="62.4993" height="61.9638" fill="transparent"/>
